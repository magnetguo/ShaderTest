...
[ExecuteInEditMode]
[AddComponentMenu ("Valkyrie/ImageEffect/Paper")]
public class ImageEffect_Paper : MonoBehaviour {
#region Variables
...
void Start () 
{
Texture2 = Resources.Load ("ImageEffect_Paper") as Texture2D;
SCShader = Shader.Find("Valkyrie/ImageEffect/Unlit/Paper");
...
{
SCShader = Shader.Find("ImageEffect_Paper");
Texture2 = Resources.Load ("Valkyrie/ImageEffect/Unlit/Paper") as Texture2D;
}
#endif
    }
    void OnDisable ()
