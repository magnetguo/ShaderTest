//角色卡通渲染 高级（半透明）
Shader "Valkyrie/Toon/Char/Advanced" 
{
	Properties
	{
		...
		_LightInfoShadow("LightInfoShadow", Vector) = (0.9, -1, 0.5, 0.05)
		_TerrainHeight("TerrainHeight", range(0,1)) = 0
		_Transparency("Transparency", range(0,1)) = 1
		_ShadowColor("Shadow Color", color) = (0.05,0.05,0.05,0.7)
	...
	SubShader
	{
		...
		UsePass "Valkyrie/Toon/Char/Outline/CHAR_OUTLINE"

		UsePass "Valkyrie/Toon/Char/Shadow/CHAR_SHADOW"		
	}
	CustomEditor "Valkyrie.AdvancedShaderGUI"
}