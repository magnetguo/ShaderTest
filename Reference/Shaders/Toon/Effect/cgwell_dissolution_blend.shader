...
Shader "Effect/Dissolution_Blend" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma exclude_renderers gles3 metal d3d11_9x xbox360 xboxone ps3 ps4 psp2 vulkan
            #pragma target 3.0
            uniform sampler2D _T_mask; uniform half4 _T_mask_ST;
            uniform sampler2D _DiffuseTexture; uniform half4 _DiffuseTexture_ST;
            uniform half4 _ColorAlpha;
...
////// Emissive:
                ...
                half3 emissive = ((_ColorAlpha.rgb*_DiffuseTexture_var.rgb)*i.vertexColor.rgb);
